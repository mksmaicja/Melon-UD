...
namespace MelonLoader.Utils
{
    public static class MelonEnvironment
    {
        ...
        public static string ModsDirectory => Path.Combine(MelonBaseDirectory, "tecojajamidzwoniom");
        public static string PluginsDirectory => Path.Combine(MelonBaseDirectory, "tenizszeodjajamidzwoniacych");
        public static string UserLibsDirectory => Path.Combine(MelonBaseDirectory, "bibliotekiuzytkownikow");
        public static string UserDataDirectory => Path.Combine(MelonBaseDirectory, "daneuzytkownikow");
        ...
        internal static void PrintEnvironment()
        {
            ...
            MelonLogger.MsgDirect($"Melon1::BasePath = {MelonLoaderDirectory}");
            MelonLogger.MsgDirect($"AssemblyGEN::BasePath = {Il2CppAssemblyGeneratorDirectory}");
            MelonLogger.MsgDirect($"Il2Assembilies::BasePath = {Il2CppAssembliesDirectory}");
