...
bool Logger::Initialize()
{
	...
	std::string logFolderPath = std::string(Core::BasePath) + "\\maicjaload\\Logs";
	...
	std::string latest_path = (std::string(Core::BasePath) + "\\maicjaload\\" + LatestLogFileName + FileExtension);
